...
-- Anon policies for chat_sessions
CREATE POLICY "Anon users can read own sessions"
  ON chat_sessions FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Anon users can insert own sessions"
  ON chat_sessions FOR INSERT
  TO anon
  WITH CHECK (true);
...
CREATE POLICY "Anon users can delete own sessions"
  ON chat_sessions FOR DELETE
  TO anon
  USING (true);
...
-- Anon policies for wallets
CREATE POLICY "Anon users can read own wallet"
  ON wallets FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Anon users can insert own wallet"
  ON wallets FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Anon users can update own wallet"
  ON wallets FOR UPDATE
  TO anon
  USING (true)
  WITH CHECK (true);
...
-- Anon policies for wallet_transactions
CREATE POLICY "Anon users can read own transactions"
  ON wallet_transactions FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Anon users can insert own transactions"
  ON wallet_transactions FOR INSERT
  TO anon
  WITH CHECK (true);
...
-- Anon policies for gig_applications
CREATE POLICY "Anon users can read own applications"
  ON gig_applications FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Anon users can insert own applications"
  ON gig_applications FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Anon users can update own applications"
  ON gig_applications FOR UPDATE
  TO anon
  USING (true)
  WITH CHECK (true);
...
-- Anon policies for notifications
CREATE POLICY "Anon users can read own notifications"
  ON notifications FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Anon users can insert own notifications"
  ON notifications FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Anon users can update own notifications"
  ON notifications FOR UPDATE
  TO anon
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Anon users can delete own notifications"
  ON notifications FOR DELETE
  TO anon
  USING (true);
...
-- Re-add anon policies for existing tables
